...
var files := []
var selected = null
var filter_popup: PopupPanel = null
var tree: Tree = null
var tree_dict := {}
...
var _scene_filter_popup: PopupPanel = null
var _script_filter_popup: PopupPanel = null
var _resource_filter_popup: PopupPanel = null
var _filter_popups := []
...
func _ready() -> void:
	...
	_scene_filter_popup = FilterMenuScene.instantiate() as PopupPanel
	...
	_script_filter_popup = FilterMenuScene.instantiate() as PopupPanel
	...
	_resource_filter_popup = FilterMenuScene.instantiate() as PopupPanel
...
func _init_config() -> void:
	var err := _config.load((get_script().get_path().get_base_dir().path_join("godot_inheritance_dock.cfg")))
	if err != OK:
		print("WARNING: ({0}::_init_config) godot_inheritance_dock.cfg failed to load!".format([get_script().get_path()]))
	_config_loaded = true
...
func _on_item_sync_requested(p_popup: PopupPanel, p_item: FilterMenuItem) -> void:
